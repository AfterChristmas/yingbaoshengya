...
public class WaveSideBar extends View {
    ...
    public WaveSideBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.WygkPlusWaveSideBar);
        mLazyRespond = typedArray.getBoolean(R.styleable.WygkPlusWaveSideBar_wygkplus_sidebar_lazy_respond, false);
        mTextColor = typedArray.getColor(R.styleable.WygkPlusWaveSideBar_wygkplus_sidebar_text_color, Color.GRAY);
        mTextSize = typedArray.getDimension(R.styleable.WygkPlusWaveSideBar_wygkplus_sidebar_text_size, sp2px(DEFAULT_TEXT_SIZE));
        mMaxOffset = typedArray.getDimension(R.styleable.WygkPlusWaveSideBar_wygkplus_sidebar_max_offset, dp2px(DEFAULT_MAX_OFFSET));
        mSideBarPosition = typedArray.getInt(R.styleable.WygkPlusWaveSideBar_wygkplus_sidebar_position, POSITION_RIGHT);
        mTextAlignment = typedArray.getInt(R.styleable.WygkPlusWaveSideBar_wygkplus_sidebar_text_alignment, TEXT_ALIGN_CENTER);
        typedArray.recycle();
