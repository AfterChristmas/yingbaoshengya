...
import com.yingbao.career.video.utils.PolyvSensorHelper;
import com.yingbao.career.video.utils.PolyvTimeUtils;
import com.yingbao.career.video.widget.PolyvNetworkDetection;
import com.yingbao.career.video.widget.PolyvTickSeekBar;
import com.yingbao.career.video.widget.PolyvTickTips;
...
public class PolyvPlayerMediaController extends PolyvBaseMediaController implements View.OnClickListener {
    ...
    //关闭
    private ImageView iv_port_finish;
    //-----------------------------------------
    // 进度条是否处于拖动的状态
    ...
    public void setFinishClickListener(OnClickListener onClickListener){
        iv_port_finish.setOnClickListener(onClickListener);
    }
}
