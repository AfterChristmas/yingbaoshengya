...
//        viewHolder.tv_size = (TextView) view.findViewById(R.id.tv_size);
        ...
        viewHolder.rl_loaded = view.findViewById(R.id.rl_loaded);
        viewHolder.rl_loading = view.findViewById(R.id.rl_loading);
        viewHolder.tv_delete_loaded = view.findViewById(R.id.tv_delete_loaded);
        viewHolder.video_preview = view.findViewById(R.id.video_preview);
    ...
    public void fillValues(final int position, View convertView) {
        ...
        if (progress == 100) {
            ...
            viewHolder.rl_loading.setVisibility(View.GONE);
            viewHolder.rl_loaded.setVisibility(View.VISIBLE);
//            viewHolder.tv_size.setVisibility(View.GONE);
            ...
            viewHolder.rl_loading.setVisibility(View.VISIBLE);
            viewHolder.rl_loaded.setVisibility(View.GONE);
...
//        viewHolder.tv_size.setText(Formatter.formatFileSize(context, filesize));
        viewHolder.pb_progress.setText(progress+"%/");;
        ...
        viewHolder.tv_delete_loaded.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((SwipeLayout) lv_download.getChildAt(position - lv_download.getFirstVisiblePosition())).close(false);
                deleteTask(position);
    ...
    private static class MyDownloadListener implements IPolyvDownloaderProgressListener2 {
        ...
        public void onDownload(long current, long total) {
            ...
            if (canUpdateView()) {
                ...
                viewHolder.get().pb_progress.setText(progress+"%/");
            }
        }
...
//                Toast.makeText(appContext, message, Toast.LENGTH_LONG).show();
    ...
    private class ViewHolder {
        ...
        RelativeLayout rl_loading,rl_loaded;
        ImageView iv_start,video_preview;
        TextView tv_seri, tv_title,/* tv_size,*/ tv_status, tv_speed, tv_delete,tv_delete_loaded;
        TextView pb_progress;
    ...
    private class DownloadOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (tv_status.getText().equals(DOWNLOADED)) {
                Intent intent = PolyvPlayerActivity.newIntent(context,0 ,downloadInfo.getTitle(),vid, true, true, fileType);
