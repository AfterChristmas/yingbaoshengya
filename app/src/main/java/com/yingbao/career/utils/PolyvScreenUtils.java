...
public class PolyvScreenUtils {
	...
	public static void setDecorVisible(Activity activity) {
		if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
			...
			decorView.setSystemUiVisibility(uiOptions);
			DisplayTools.setFullScreenTranslucentStatusbar(activity);
		}
	}
	...
	public static void showNavigationBar(Activity activity){
		int uiOptions=activity.getWindow().getDecorView().getSystemUiVisibility();
		activity.getWindow().getDecorView().setSystemUiVisibility(uiOptions| View.SYSTEM_UI_FLAG_LIGHT_NAVIGATION_BAR);
	}
