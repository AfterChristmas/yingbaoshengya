 ...
 */
public class TestKnowPointTreeItemHolder extends TreeNode.BaseNodeViewHolder<TestKnowPointTreeItemHolder.IntelligenceIconTreeItem> {
    private TextView tvValue;
    private ImageView arrowView;
    private ShadowView shadow_view;

    public TestKnowPointTreeItemHolder(Context context) {
        super(context);
    }
    ...
    public View createNodeView(final TreeNode node, IntelligenceIconTreeItem value) {
        ...
        tvValue.setText(value.knowledgePointBean.getName());
    ...
    public static class IntelligenceIconTreeItem {
        public TestKnowPointResult.ResultBean knowledgePointBean;

        public IntelligenceIconTreeItem(TestKnowPointResult.ResultBean knowledgePointBean) {
