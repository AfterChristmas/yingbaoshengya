...
import com.yingbao.career.ui.question.adapter.AbsHolder;
import com.yingbao.career.ui.question.adapter.AbsRVAdapter;
 ...
 * 下载列表适配器
 */
public class DownloadingVideoAdapter extends AbsRVAdapter<AbsEntity, DownloadingVideoAdapter.SimpleHolder> {
  private static final String TAG = "DownloadAdapter";
  private Map<String, Integer> mPositions = new ConcurrentHashMap<>();

  public DownloadingVideoAdapter(Context context, List<AbsEntity> data) {
    super(context, data);
    int i = 0;
  ...
  @Override protected int setLayoutId(int type) {
    if (type == 1) {
      return R.layout.item_downloading_video;
    }
  ...
  class SimpleHolder extends AbsHolder {
    ...
    SimpleHolder(View itemView) {
      ...
      cancel = itemView.findViewById(R.id.tv_delete);
      name = itemView.findViewById(R.id.tv_title);
      bt = itemView.findViewById(R.id.tv_status);
    }
  }
